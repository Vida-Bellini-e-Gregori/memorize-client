...
export function DifficultyButtons({ handleSetDifficulty }: DifficultyButtonsProps) {
  return (
    <div className="flex gap-5 relative">
      <Button label="Fácil" color='bg-green-600' onClick={() => handleSetDifficulty(1)}
        className="hover:bg-green-700"
      />
      <Button label="Médio" color='bg-yellow-500' onClick={() => handleSetDifficulty(2)}
        className="hover:bg-yellow-600"
      />
      <Button label="Difícil" color='bg-red-500' onClick={() => handleSetDifficulty(3)}
